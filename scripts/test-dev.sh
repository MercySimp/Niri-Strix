...
# Launch windowed so it sits inside your Niri session like any other window.
# When you're ready for full kiosk mode, use the gamescope launch instead.
exec "$QML_BIN" \
    -geometry 1280x800 \
    /usr/share/deck-shell/main.qml
